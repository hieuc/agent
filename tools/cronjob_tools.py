...
Important safety rule: cron-run sessions should not recursively schedule more cron jobs.""",
    "parameters": {
        ...
        "properties": {
            ...
            "schedule": {
                "type": "string",
                "description": "REQUIRED for action=create. For create/update: '30m', 'every 2h', 'every 5h starting in 2.5h', '0 9 * * *', or ISO timestamp. Examples: '30m' (one-shot in 30 minutes), 'every 2h' (every 2 hours, first run in 2 hours), 'every 5h starting in 2.5h' (every 5 hours, first run in 2.5 hours), '0 9 * * *' (daily at 9am), '2026-06-01T09:00:00' (one-shot). You MUST include this field when action=create."
            },
            "name": {
                "type": "string",
